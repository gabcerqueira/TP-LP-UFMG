...
| 14 => (LPAR (yypos, yypos))
| 16 => (RPAR (yypos, yypos))
| 18 => (LCOLCH (yypos, yypos))
| 20 => (RCOLCH (yypos, yypos))
| 22 => (LCHAV (yypos, yypos))
| 24 => (RCHAV (yypos, yypos))
| 26 => (COLON (yypos, yypos))
| 28 => (COMMA (yypos, yypos))
| 30 => (SEMIC (yypos, yypos))
| 32 => (BAR (yypos, yypos))
| 34 => (UNDERL (yypos, yypos))
| 37 => (AROW (yypos, yypos))
| 4 => (lex())
| 40 => (ARROW (yypos, yypos))
| 42 => (PLUS (yypos, yypos))
| 44 => (MINUS (yypos, yypos))
| 46 => (TIMES (yypos, yypos))
| 48 => (DIV (yypos, yypos))
| 50 => (EQ (yypos, yypos))
| 53 => (DIFF (yypos, yypos))
| 55 => (LT (yypos, yypos))
| 58 => (LTE (yypos, yypos))
| 61 => (CONCAT (yypos, yypos))
| 64 => let val yytext=yymktext() in keyword (yytext, yypos, yypos) end
